...
#pragma once
#include "..\..\..\..\AudioRecordingDemo\Source\DanteAudioIODevice.h"
#ifndef DOXYGEN
...
public:
    ...
    */
    ...
    {
        // Add Dante Device Type
        auto deviceType = this->createAudioIODeviceType();
        if (deviceManager.getAvailableDeviceTypes().indexOf(deviceType) == -1)
            deviceManager.addAudioDeviceType(std::unique_ptr<AudioIODeviceType>(deviceType));
